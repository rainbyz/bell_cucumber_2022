...
public class CustomAllureSelenide extends AllureSelenide {
    ...
    public void afterEvent(LogEvent event) {
        String type = Properties.selenideScreenshotModeProperties.getType();
        if (type.equals("always") ||
                (type.equals("pass") && event.getStatus().equals(LogEvent.EventStatus.PASS)) ||
                (type.equals("fail") && event.getStatus().equals(LogEvent.EventStatus.FAIL))) {
